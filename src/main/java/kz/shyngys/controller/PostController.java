...
public class PostController {
    ...
    public PostDto create(String content, Long writerId, Set<LabelDto> labels) {
    ...
    public PostDto update(Long id, Long writerId, String content, Set<LabelDto> labels) {
        PostDto postDto = PostDto.builder()
                .id(id)
                .content(content)
                .writerId(writerId)
    ...
    public PostDto addLabelsToPost(Long id, Set<LabelDto> labels) {
        PostDto postDto = PostDto.builder()
                .id(id)
                .status(Status.ACTIVE)
                .labels(labels)
